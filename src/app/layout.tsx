  ...
  return (
    ...
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${fraunces.variable} overflow-x-clip`}>
      ...
      <body className="antialiased overflow-x-clip">
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-WHBPXY1YRW"
          strategy="afterInteractive"
        />
        <Script id="gtag-init" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-WHBPXY1YRW');`}
        </Script>
      </body>
    </html>
  );
